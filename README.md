...
**Data Sources:**  
- *Campaign Manifesto for World Autism Awareness Day (Autism-Europe, 2020)*  
  https://www.autismeurope.org/wp-content/uploads/2020/06/WAAD-2020_Manifesto_EN.pdf  
- *World Autism Awareness Day Proclamation (The White House, 2025)*  
...
📉 **Limitations**
- The analysis is based on publicly available sources that already aggregated or pre-processed the data; large raw datasets from official statistical databases were not imported or modeled directly.  
